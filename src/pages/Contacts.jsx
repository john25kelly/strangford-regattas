...
const contacts = [
  ...
  { id: 5, name: 'Kircubbin Sailing Club', role: 'Club Rep: Pete McDowell', phone: null, email: 'sailing@kircubbinsailing.club', website: normalizeWebsite('kircubbinsailing.club') },
